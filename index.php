...
<head>
  ...
  <title>Room finder protal</title>
        ...
        <div class="isotope-layout" data-default-filter=".main" data-layout="masonry" data-sort="original-order">
          ...
          <div class="row align-items-center">
            <div class="col-lg-7 portfolio-info">
              ...
              <p> E-voting  : Easy and Speedy, Peace </p>
            </div>
            <div class="col-lg-5 text-center text-lg-end">
              <ul class="portfolio-filters isotope-filters" data-aos="fade-up" data-aos-delay="100">
                <li data-filter=".main" class="filter-active">All</li>
                <li data-filter=".filter-app" style="text-align: center;"> <img src="assets/img/tree.png"> <br> NC </li>
                <li data-filter=".filter-product" style="text-align: center;"> <img src="assets/img/sun.png"> <br> UML </li>
                <li data-filter=".filter-branding">CPN</li>
                <li data-filter=".filter-books">RSP</li>
              </ul>
            </div>
          </div>
          ...
          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200" style="position: relative; height: 1344px;">
            ...
            <div class="col-lg-8 offset-2 portfolio-item isotope-item main" style="position: absolute; left: 0px; top: 0px;">
              ...
              <table class="table  table-striped table-light caption-top">
                <thead>
                  <caption>List of Candidate</caption>
                  <tr>
                    <th scope="col">SN</th>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app" style="position: absolute; left: 0px; top: 0px;">
              <div class="portfolio-content h-100"style="text-align: center;">
                <img src="assets/img/portfolio/app-1.jpg" class="img-fluid" width="200" height="200" style="border-radius: 78px;">
                <div class="portfolio-custom" style="padding: 20px;">
                  <h4>John Smith</h4>
                  <p>USA , LA ,10010</p>
            ...
            <div class="col-lg-4 col-md-6 portfolio-item isotope-item filter-app" style="position: absolute; left: 0px; top: 0px;">
              <div class="portfolio-content h-100"style="text-align: center;">
                <img src="assets/img/portfolio/app-2.jpg" class="img-fluid" width="200" height="200" style="border-radius: 78px;">
                <div class="portfolio-custom" style="padding: 20px;">
                  <h4>John wick</h4>
                  <p>USA , LA ,10010</p>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
            <div class="service-item  position-relative">
              ...
              <h3>7x24 hrs water</h3>
              <p>Enjoy a continuous water supply available 24/7. Reliable and uninterrupted access at all times..</p>
